...
class EventServiceProvider extends ServiceProvider
{
     ...
     */
    protected $listen = [
        'user.login' => ['app\locker\listeners\LoginHandler'],
        'user.domain_check' => ['app\locker\listeners\RegisterHandler@domain_check'],
        'user.register' => ['app\locker\listeners\RegisterHandler'],
        'user.email_resend' => ['app\locker\listeners\RegisterHandler@resentEmailVerification'],
    ];
    ...
    public function boot()
    {
      ...
      // Event::listen('App.after', function($request, $response) {
