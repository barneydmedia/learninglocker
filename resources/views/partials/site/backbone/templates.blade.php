<script id="lrsTemplate" type="text/template">
  ...
  <td class="text-center">
    <a href="/lrs/<%= _id %>/edit" class="btn btn-xs btn-success btn-space" title="{{ Lang::get('site.edit') }}"><i class="icon-pencil"></i></a>
  </td>
  <td class="text-center">
...
<script id="userTemplate" type="text/template">
  ...
  <td class="col-sm-3">
    ...
    <% _.each(lrs_member, function(member) { %>  
      <a href="/lrs/<%= member._id %>"><%= member.title %></a>, 
    <% }); %>
    </p>
    <% } %>
  </td>
...
<script id="addNewLrs" type="text/template">
  <a href="/lrs/create" class="btn btn-primary pull-right">{{ Lang::get('lrs.create') }}
</script>

<script id="addNewUser" type="text/template">
  <a href="/site/invite" class="btn btn-primary pull-right">{{ Lang::get('users.invite.invite') }}
</script>

<script id="editSettings" type="text/template">
  <a href="/site/<%= _id %>/edit" class="btn btn-primary pull-right">{{ Lang::get('site.edit_settings') }}
</script>
